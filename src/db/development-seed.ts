...
export const DEV_FIXTURE_IDS = {
  users: {
    ...
    james: '31000000-0000-4000-8000-000000000005',
    lucy: '31000000-0000-4000-8000-000000000006',
    samuel: '31000000-0000-4000-8000-000000000007',
    wanjiku: '31000000-0000-4000-8000-000000000008',
    brian: '31000000-0000-4000-8000-000000000009',
    esther: '31000000-0000-4000-8000-000000000010',
  },
  chamas: {
  ...
  for (const identity of identities) {
    await client.query(
      `INSERT INTO users
       ...
       VALUES ($1, $2, $3, $4, $5, 'active', TRUE, FALSE, '2026-09-01T00:00:00Z', '2026-09-01T00:00:00Z')
      ...
      [identity.id, identity.email, hashByPin.get(identity.pin), identity.fullName, identity.phone],
    );
  }
}
