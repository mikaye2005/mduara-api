...
router.post('/reset-pin', validateBody(resetPinSchema), asyncHandler(authController.resetPin));
...
router.patch('/pin', authenticate, validateBody(changePinSchema), asyncHandler(authController.changePin));
